    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, max_length=150)),
                ('is_active', models.BooleanField(default=False, verbose_name='Прошел активацию')),
